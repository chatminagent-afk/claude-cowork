<!-- Diekstrak otomatis dari 2026-09-03-VIRA-Personal-Main-patched.json (node AI Agent).
...
`[DECK_REQUEST]`
  ...
  dan mengabarkan deck yang tidak dia minta terdengar memaksa. Tawarkan saja, sekali:
