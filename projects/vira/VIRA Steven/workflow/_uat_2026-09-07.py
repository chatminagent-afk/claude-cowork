...
Jalankan: python _uat_2026-09-07.py
...
WF = os.path.join(DIR, "2026-09-07-VIRA-Personal-Main-v3.6.json")
...
for i, langkah in enumerate([
    ...
    "Import 2026-09-07-VIRA-Personal-Main-v3.6.json, aktifkan, matikan versi lama.",
