# -*- coding: utf-8 -*-
"""
_uat_2026-09-05.py — UAT perilaku untuk 2026-09-05-VIRA-Personal-Main-v3.json.
...
Jalankan: python _uat_2026-09-05.py
...
WF = os.path.join(DIR, "2026-09-05-VIRA-Personal-Main-v3.json")
...
print("=" * 72)
print("UAT PERILAKU — VIRA Personal v3 (2026-09-05)")
...
for i, langkah in enumerate([
    "Tambah 2 kolom di tab STATS: last_bot_reply, last_bot_reply_ts (paling kanan).",
    "Pastikan CONFIG: whitelist_enabled kosong/false, bot_wa_number = nomor VIRA.",
    "Import 2026-09-05-VIRA-Personal-Main-v3.json, aktifkan, matikan versi lama.",
