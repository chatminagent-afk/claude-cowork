...
Jalankan: python _uat_2026-09-06b.py
...
WF = os.path.join(DIR, "2026-09-06-VIRA-Personal-Main-v3.2.json")
...
for i, langkah in enumerate([
    ...
    "Import 2026-09-06-VIRA-Personal-Main-v3.2.json, aktifkan, matikan versi lama.",
