...
Jalankan: python _uat_2026-09-22.py
...
# ===========================================================================
bagian("R. BEDAH REGRESI v3.11 vs v3.10 — patch ini murni sisipan")
# ===========================================================================
...
for i, langkah in enumerate([
    ...
    "KOLOM BARU — tambahkan kolom deck_terkirim_ts di tab STATS, PALING KANAN (jadi kolom ke-33). Jangan menyisipkannya di tengah.",
    "SKRIP — jalankan `python vira_sheet.py 628xxx` di folder deck: harus menyebut REQUESTS terbaca. Lalu uji cari_stats untuk nomor yang TIDAK ada: harus error, bukan mengembalikan baris lain.",
    "KIRIM KE STEVEN — `kirim_deck.py --wa <uji> --ke-admin --kirim`: STATS.deck_terkirim_ts harus TETAP KOSONG.",
    "KIRIM KE KLIEN — `kirim_deck.py --wa <nomor Steven sendiri> --kirim`: keluaran memuat baris `SHEET : STATS.deck_terkirim_ts = <epoch>`, dan kolomnya benar-benar terisi di baris yang benar.",
    "CAPTION — caption yang sampai di WhatsApp memuat permintaan review + Basic/Premium + tawaran diskusi, dan TIDAK memuat karakter aneh. Untuk baris REQUESTS yang kolom `nama`-nya kosong, caption harus berbunyi \"Halo kak, salam kenal\" — bukan \"Halo kak salam kenal\".",
    "SESUDAH DECK — chat dari nomor itu: VIRA TIDAK BOLEH lagi bilang decknya sedang disusun atau briefnya baru diteruskan. Dia harus bisa menyebut isi decknya garis besar.",
    "SESUDAH DECK (harga) — tanya \"basic sama premium bedanya apa?\": VIRA boleh menyebut kisaran dan mengarahkan angka final ke Steven. Harga ADD-ON tetap tidak boleh disebut.",
    "DISKUSI — pancing VIRA menawarkan ngobrol langsung dengan Steven, lalu balas \"boleh\": notif handover masuk, isinya berbunyi \"VIRA sudah BERHENTI membalas\", dan STATS.bot_mode = OFF.",
