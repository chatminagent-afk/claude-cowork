...
def baris_cfg(**over):
    d = {"bot_name": "VIRA", "admin_phone": "6285171701168",
         ...
         "kirimi_secret": "4efe3780e1c0b53c56ad02fedc8b39a64b7c671f",
...
for i, langkah in enumerate([
    "DEPLOY — di workflow 'VIRA Personal — Main' yang live, ganti isinya dengan 2026-09-25-VIRA-Personal-Main-v3.14.json (ID tetap). Tidak ada kolom/node baru.",
